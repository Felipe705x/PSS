...
.while_begin:           #     // del ciclo para mayor eficiencia
    ...
    li      t6,0        # para indicar cuando continuar
.word_count:
    lw      a6,0(t0)    # a6 = t0[0] es el argumento que utliza word_count
	mv	    a5,a6
	lbu	    a4,0(a6)
	beq	    a4,zero,.L5
	li	    a3,1
...
.compare:
    ...
    mv      t1,a6
    li      t6,1
    addi    t0,t0,4     # avanzamos t0
    j       .word_count
.continue:
    sub     t1,t1,a6    # t1 = word_count(p[0]) - word_count(p[1])
